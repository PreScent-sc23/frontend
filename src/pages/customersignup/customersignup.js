    ...
    return(
        <div >
            ...
            <div style={{width:'100%', textAlign:'center',marginTop:'1rem'}}>
                ...
                <input className={styles.inputBox} type='password' name = "validnum" size = '50'  placeholder='비밀번호 재입력' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}></input>
                </form>
